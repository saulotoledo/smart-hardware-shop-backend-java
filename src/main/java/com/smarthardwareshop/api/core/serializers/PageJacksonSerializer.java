package com.smarthardwareshop.api.core.serializers;
...
/**
 * Serializes the default Page result. The code is adapted from
...
public class PageJacksonSerializer extends JsonSerializer<Page<?>> {
    ...
    public void serialize(Page page, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        // Fixes the page number when using one-indexed pages. Be sure you are using
